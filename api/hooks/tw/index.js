    ...
    if (chunk.retweeted_status !== undefined) {
      this.push({
        a: {
          ...
          text: chunk.text,
          cur_d: chunk.created_at,
          likes: chunk.favorite_count,
          mes_id: chunk.id,
          au_id: chunk.user.id_str
        },
        b: {
          Name: chunk.user.screen_name,
          au_id: chunk.user.id_str,
          link: chunk.user.url,
          av: chunk.user.profile_image_url,
          friends: chunk.user.friends_count
        },
        c: {
          Name: chunk.retweeted_status.user.screen_name,
          text: chunk.retweeted_status.text,
          cur_d: chunk.retweeted_status.created_at,
          likes: chunk.retweeted_status.favorite_count,
          retw: chunk.retweet_count,
          mes_id: chunk.id
        }
      });
    }
